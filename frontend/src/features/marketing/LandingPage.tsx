...
const PORTFOLIO: {
  ...
  },
  {
    ...
    body: "Live systematic momentum engine that trades listed equities. Runs a proprietary volatility-adjusted score and executes with position sizing that scales inversely to realised risk.",
    deliverables: [
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Backtested across the large-cap universe",
    ],
  ...
  },
  {
    ...
    deliverables: [
      "Real-time market breadth ingestion",
  ...
  },
  {
    ...
    body: "Company selection module for a swing-trading engagement - ranks a mid-to-large cap universe on 3/6/9-month trends, smoothness, higher-highs consistency and quarterly fundamentals, with every setting exposed for admin tuning.",
    deliverables: [
      ...
      return (
        <svg viewBox="0 0 320 128" className="w-full h-full" aria-hidden>
          ...
          <text x="14" y="20" fill="rgba(255,255,255,0.95)" fontFamily="ui-sans-serif, system-ui" fontSize="9" fontWeight="700">
            RANKED SHORTLIST · MID-LARGE CAP
          </text>
          {/* Table header */}
