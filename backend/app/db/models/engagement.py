...
class Engagement(UUIDPKMixin, TimestampMixin, Base):
    ...
    # Optional link to an external product surface the client has (e.g. Ravi's
    # standalone Ravi VAM dashboard on Render). Rendered as an "Open your
    # product" card on the client's Overview. Coexists with native VAM
    # integration - both surfaces are shown when both are configured.
