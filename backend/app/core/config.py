...
class Settings(BaseSettings):
    ...
    SMTP_PASSWORD: str = ""
    SMTP_FROM: str = ""
    SMTP_FROM_NAME: str = "IFA Client Portal"
    ...
    def vam_configured(self) -> bool:
        """True when the VAM engine base URL is set. Auth env vars are unused
        now that the engine runs on our private docker network."""
        return bool(self.VAM_BASE_URL)
